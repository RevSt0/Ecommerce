...
describe('OrderItem Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Product query and add missing value', () => {
      ...
      const product: IProduct = { id: 8238 };
      orderItem.product = product;

      const productCollection: IProduct[] = [{ id: 6988 }];
    ...
    it('Should call ProductOrder query and add missing value', () => {
      const orderItem: IOrderItem = { id: 456 };
      const order: IProductOrder = { id: 2536 };
      orderItem.order = order;

      const productOrderCollection: IProductOrder[] = [{ id: 2806 }];
    ...
    it('Should update editForm', () => {
      const orderItem: IOrderItem = { id: 456 };
      const product: IProduct = { id: 8897 };
      orderItem.product = product;
      const order: IProductOrder = { id: 7032 };
      orderItem.order = order;
