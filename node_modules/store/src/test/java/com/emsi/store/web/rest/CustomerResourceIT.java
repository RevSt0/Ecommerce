...
import com.emsi.store.IntegrationTest;
import com.emsi.store.domain.Customer;
import com.emsi.store.domain.User;
import com.emsi.store.domain.enumeration.Gender;
import com.emsi.store.repository.CustomerRepository;
import com.emsi.store.repository.EntityManager;
import com.emsi.store.service.CustomerService;
...
class CustomerResourceIT {
    ...
    private static final String DEFAULT_EMAIL = "/d@_OG.$$";
    private static final String UPDATED_EMAIL = "jD3@]i.2E3";
    ...
    void partialUpdateCustomerWithPatch() throws Exception {
        ...
        partialUpdatedCustomer.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME).gender(UPDATED_GENDER).email(UPDATED_EMAIL);
